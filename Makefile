...
ifeq (newlib,$(TOOLCHAIN))
	$(MAKE) -C third_party/naclports fftw NACL_ARCH=i686
	$(MAKE) -C third_party/naclports fftw NACL_ARCH=x86_64
	$(MAKE) -C third_party/naclports fftw NACL_ARCH=arm
endif
ifeq (pnacl,$(TOOLCHAIN))
	$(MAKE) -C third_party/naclports fftw NACL_ARCH=pnacl
endif
